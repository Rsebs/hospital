...
if ($result->rowCount() > 0) {
	foreach ($result as $r) {
				...
				<div class="modal-dialog modal-lg modal-dialog-scrollable">
					<div class="modal-content">
						...
						<div class="modal-body">
							<fieldset>
								<legend class="text-secondary mb-4">' . $r['name'] . '</legend>
								<p class="mb-4"><strong>Nombre de género: </strong>' . $r['name'] . '</p>
								<p class="mb-4"><strong>Código: </strong>' . $r['cod'] . '</p>
		...
		<div>
			...
			<form action="' . $genderController . '/update.php" method="POST">
							...
							<div class="modal-body">
								...
								<div class="mt-4 row">
									<div class="col-md input-group mb-4">
										...
										<input type="text" name="name" class="form-control" placeholder="Ej: Masculino" value="' . $r['name'] . '" required>
									</div>
									<div class="col-md input-group mb-4">
										<label for="cod" class="input-group-text">Código</label>
										<input type="text" name="cod" class="form-control" placeholder="Ej: M" value="' . $r['cod'] . '" required>
									</div>
								</div>
							</div>
							<div class="modal-footer">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<p><strong>Código: </strong>' . $r['cod'] . '</p>
							<p><strong>Ingreso: </strong>' . $r['create_date'] . '</p>
							<p><strong>Último movimiento: </strong>' . $r['edit_date'] . '</p>
						</div>
						<div class="modal-footer">
							<form action="' . $genderController . '/destroy.php" method="POST" data-type-form="delete">
